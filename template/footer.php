    ...
    <div class="container-fluid m-0 row">
        <div class="col-12 col-xl-4  ">
            ...
            <div class="mb-3 p-2 row">
                <label for="exampleFormControlInput1" class="form-label text-dark">Inscrivez vous à la newsletter</label>
                <div class="col-8  ">
        ...
        <div class="col-12 col-xl-5   ">
            ...
            <a class="text-white m-auto row " href="contact">
        ...
        <div class="col-12 col-xl-3">
            ...
            <div class="m-auto row col-12">
                <a href="https://www.facebook.com/sca2000Aviron/">
                    <i class="iconefacebook iconify  text-dark" data-icon="et:facebook" data-inline="false"> </i></a>
            </div>
        </div>
    </div>
</footer>
